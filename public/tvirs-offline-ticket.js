...
(function () {
    ...
    function createModalElement() {
        ...
        modal.innerHTML = [
            '<div class="off-ticket-backdrop" style="position:absolute;inset:0;background:rgba(5,13,26,0.85);backdrop-filter:blur(4px);"></div>',
            '<div class="off-ticket-container" style="position:relative;background:#fff;width:100%;max-width:440px;max-height:92vh;border-radius:20px;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 25px 50px -12px rgba(0,0,0,0.45);z-index:1;">',
            '  <div class="off-ticket-header" style="background:linear-gradient(135deg, #050d1a, #0a1946);color:#fff;padding:12px 16px;display:flex;align-items:center;justify-content:space-between;flex-shrink:0;border-bottom:1px solid rgba(255,255,255,0.08);">',
            '    <div style="display:flex;align-items:center;gap:8px;">',
            '      <i class="ph-bold ph-printer" style="font-size:1.25rem;color:#93c5fd;"></i>',
            '      <div>',
            '        <div style="font-weight:800;font-size:.92rem;line-height:1.2;">Citation Ticket Print</div>',
            '        <div style="font-size:.7rem;color:#bfdbfe;">Official Thermal Citation Slip</div>',
            '      </div>',
            '    </div>',
            '    <button type="button" id="off-ticket-close-btn" style="background:rgba(255,255,255,.15);border:none;color:#fff;width:28px;height:28px;border-radius:8px;display:flex;align-items:center;justify-content:center;cursor:pointer;font-size:1.1rem;">',
            ...
            '      <button type="button" id="off-btn-print-bt" style="flex:1;background:linear-gradient(135deg, #1e4fb5, #2563eb);color:#fff;border:none;padding:12px 14px;border-radius:10px;font-size:.88rem;font-weight:800;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;box-shadow:0 4px 14px rgba(37,99,235,0.35);">',
