...
class DemoDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $violationsData = [
            // Settled violations
            ['violator' => 0, 'vehicle' => 0, 'type' => 'Speeding',            'date' => now()->subDays(90), 'location' => 'EDSA, Quezon City',           'ticket' => 'TVIRS-CEB-BAL-2026-000001', 'status' => 'settled', 'notes' => 'Caught on radar at 82 kph in a 60 kph zone.', 'settled_at' => now()->subDays(85), 'or_number' => 'OR2026-0001', 'cashier_name' => 'Maria Santos'],
            ['violator' => 0, 'vehicle' => 1, 'type' => 'Beating Red Light',   'date' => now()->subDays(60), 'location' => 'España Blvd., Manila',         'ticket' => 'TVIRS-CEB-BAL-2026-000002', 'status' => 'settled', 'notes' => 'Ran red light at España-Lacson intersection.', 'settled_at' => now()->subDays(55), 'or_number' => 'OR2026-0002', 'cashier_name' => 'Juan dela Cruz'],
            ['violator' => 2, 'vehicle' => 3, 'type' => 'No Seatbelt',         'date' => now()->subDays(45), 'location' => 'C5 Road, Pasig City',          'ticket' => 'TVIRS-CEB-BAL-2026-000003', 'status' => 'settled', 'notes' => 'Driver and front passenger not wearing seatbelts.', 'settled_at' => now()->subDays(40), 'or_number' => 'OR2026-0003', 'cashier_name' => 'Maria Santos'],
            ['violator' => 4, 'vehicle' => 4, 'type' => 'Illegal Parking',     'date' => now()->subDays(30), 'location' => 'Ayala Ave., Makati City',      'ticket' => 'TVIRS-CEB-BAL-2026-000004', 'status' => 'settled', 'notes' => 'Parked in a no-parking zone near BPI main office.', 'settled_at' => now()->subDays(25), 'or_number' => 'OR2026-0004', 'cashier_name' => 'Juan dela Cruz'],
            ['violator' => 1, 'vehicle' => 2, 'type' => 'Counterflow',         'date' => now()->subDays(20), 'location' => 'Commonwealth Ave., QC',        'ticket' => 'TVIRS-CEB-BAL-2026-000005', 'status' => 'settled', 'notes' => 'Drove against traffic flow to avoid congestion.', 'settled_at' => now()->subDays(15), 'or_number' => 'OR2026-0005', 'cashier_name' => 'Maria Santos'],

            // Overdue (pending, >72 hours ago) — repeat offenders
            ['violator' => 0, 'vehicle' => 0, 'type' => 'Reckless Driving',    'date' => now()->subDays(10), 'location' => 'Roxas Blvd., Pasay City',      'ticket' => 'TVIRS-CEB-BAL-2026-000006', 'status' => 'pending', 'notes' => 'Weaving through traffic at high speed.'],
            ['violator' => 0, 'vehicle' => 1, 'type' => 'Speeding',            'date' => now()->subDays(8),  'location' => 'McArthur Highway, Caloocan',   'ticket' => 'TVIRS-CEB-BAL-2026-000007', 'status' => 'pending', 'notes' => 'Clocked at 95 kph in 60 kph zone.'],
            ['violator' => 2, 'vehicle' => 3, 'type' => 'Illegal U-Turn',      'date' => now()->subDays(7),  'location' => 'Buendia Ave., Makati',         'ticket' => 'TVIRS-CEB-BAL-2026-000008', 'status' => 'pending', 'notes' => 'Made U-turn in a no-U-turn zone.'],
            ['violator' => 2, 'vehicle' => 3, 'type' => 'No Driver\'s License','date' => now()->subDays(5),  'location' => 'Ortigas Ave., Mandaluyong',    'ticket' => 'TVIRS-CEB-BAL-2026-000009', 'status' => 'pending', 'notes' => 'Unable to present driver\'s license when flagged.'],
            ['violator' => 6, 'vehicle' => 5, 'type' => 'Distracted Driving',  'date' => now()->subDays(6),  'location' => 'Quezon Ave., Quezon City',     'ticket' => 'TVIRS-CEB-BAL-2026-000010', 'status' => 'pending', 'notes' => 'Using mobile phone while driving.'],
            ['violator' => 4, 'vehicle' => 4, 'type' => 'Overloading (Passengers)', 'date' => now()->subDays(4), 'location' => 'EDSA, Cubao',             'ticket' => 'TVIRS-CEB-BAL-2026-000011', 'status' => 'pending', 'notes' => 'Van carrying 18 passengers, capacity is 12.'],
            ['violator' => 7, 'vehicle' => 6, 'type' => 'No Helmet',           'date' => now()->subDays(3),  'location' => 'Aurora Blvd., Cubao',         'ticket' => 'TVIRS-CEB-BAL-2026-000012', 'status' => 'pending', 'notes' => 'Motorcycle rider without helmet.'],

            // Recent pending (within 72 hours)
            ['violator' => 3, 'vehicle' => null, 'type' => 'No Vehicle Registration', 'date' => now()->subHours(6), 'location' => 'Taft Ave., Manila', 'ticket' => 'TVIRS-CEB-BAL-2026-000013', 'status' => 'pending', 'notes' => 'No valid OR/CR presented.'],
            ['violator' => 5, 'vehicle' => null, 'type' => 'Illegal Parking',  'date' => now()->subHours(3),  'location' => 'Shaw Blvd., Mandaluyong',   'ticket' => 'TVIRS-CEB-BAL-2026-000014', 'status' => 'pending', 'notes' => 'Double parked blocking traffic.'],
            ['violator' => 1, 'vehicle' => 2,    'type' => 'Beating Red Light', 'date' => now()->subHours(2), 'location' => 'Katipunan Ave., QC',         'ticket' => 'TVIRS-CEB-BAL-2026-000015', 'status' => 'pending', 'notes' => 'Caught on CCTV running red light.'],
            ...
            ['violator' => 3, 'vehicle' => 0,    'type' => 'Speeding',          'date' => now()->subDays(12), 'location' => 'Quezon Ave., Quezon City',    'ticket' => 'TVIRS-CEB-BAL-2026-000016', 'status' => 'settled',  'notes' => 'Borrowed vehicle. Driver is not the registered owner.', 'settled_at' => now()->subDays(10), 'or_number' => 'OR2026-0006', 'cashier_name' => 'Juan dela Cruz'],
            // Josephine (violator 5) driving Emmanuel\'s Toyota Hiace (vehicle 4 — owned by violator 4)
            ['violator' => 5, 'vehicle' => 4,    'type' => 'Loading / Unloading Violation', 'date' => now()->subDays(9), 'location' => 'Ayala Ave., Makati City', 'ticket' => 'TVIRS-CEB-BAL-2026-000017', 'status' => 'pending',  'notes' => 'Loading passengers at a prohibited zone. Driver is not the registered owner.'],
        ];
