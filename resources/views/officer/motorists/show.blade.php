...
@forelse($incidents as $inc)
    @php
        $incAccentClass = ['reported' => 'motshow-accent--open', 'assigned_for_investigation' => 'motshow-accent--open', 'under_assessment' => 'motshow-accent--review'][$inc->status] ?? 'motshow-accent--closed';
        $incIcon   = ['reported' => 'motshow-item-icon--danger', 'assigned_for_investigation' => 'motshow-item-icon--danger', 'under_assessment' => 'motshow-item-icon--blue'][$inc->status] ?? 'motshow-item-icon--slate';
        $sc = ['reported' => 'mob-badge-open', 'assigned_for_investigation' => 'mob-badge-open', 'under_assessment' => 'mob-badge-review'][$inc->status] ?? 'mob-badge-closed';
    @endphp
