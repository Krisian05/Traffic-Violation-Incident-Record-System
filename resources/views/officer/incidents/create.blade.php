...
<div class="mob-card">
    <div class="mob-card-body">
        <form method="POST" action="{{ route('officer.incidents.store') }}" enctype="multipart/form-data" id="incidentForm" data-offline-sync="true" data-offline-record-type="incident-create" data-offline-label="Incident">
            ...
            <div class="mb-4" style="font-size:.78rem;color:#78716c;">
                <i class="bi bi-info-circle me-1"></i> New incidents start with status <strong>Reported</strong>. You can progress the case from the incident's edit screen afterward.
            </div>
            ...
            <div class="mb-3" style="font-size:.78rem;color:#94a3b8;">Passengers, witnesses, reporting parties, responding personnel, and others (pedestrians, cyclists, bystanders, etc.)</div>
