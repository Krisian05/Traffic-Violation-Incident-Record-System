                        ...
                        <div class="d-flex align-items-end gap-2">
                            <div style="flex:1;">
                                ...
                                <input type="number" step="0.0000001" name="gps_lat" id="gps_lat"
                                       ...
                                       placeholder="e.g. 10.5012345" value="{{ old('gps_lat', $violation->gps_lat) }}"
                            ...
                            <div style="flex:1;">
                                ...
                                <input type="number" step="0.0000001" name="gps_lng" id="gps_lng"
                                       ...
                                       placeholder="e.g. 123.7654321" value="{{ old('gps_lng', $violation->gps_lng) }}"
                                       style="font-family:ui-monospace,monospace;">
                            </div>
