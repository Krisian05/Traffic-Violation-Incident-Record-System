...
class OfficerController extends Controller
{
    ...
    public function dashboard(): View
    {
        ...
        return view('officer.dashboard', compact('motoristCount', 'violationCount', 'incidentCount', 'openIncidentCount', 'overdueCount', 'overdueViolations'));
    }
    ...
    public function violations(Request $request): RedirectResponse
    {
        return redirect()->route('officer.motorists.index');
    }
    ...
    public function storeIncident(Request $request): RedirectResponse
    {
        ...
        $parties = collect($request->input('parties', []))
            ->filter(fn($p) => !empty($p['role']))->values()->toArray();

        $incident = DB::transaction(function () use ($request, $parties) {
