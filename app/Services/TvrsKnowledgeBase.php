...
1. CASHIER & FINANCIAL SETTLEMENTS:
...
2. SMS GATEWAY & DISPATCHING (/sms-gateway):
...
3. MOTORISTS, VEHICLES & VIOLATIONS MANAGEMENT:
   - Motorists (/violators): Master record of traffic violators. View full violation history, total unpaid fines, driver's license details, and contact numbers.
...
4. INCIDENTS & CHARGE TYPES (/incidents & /incident-charge-types):
...
7. USER MANAGEMENT & ENFORCER DEVICES (/users):
   - Creating Accounts: LGU Admins create accounts for Enforcers, Cashiers, Supervisors, and Auditors.
   - Mobile Device Pairing: Register issuing officers' mobile smartphones to ensure tickets can only be submitted from authorized devices.
