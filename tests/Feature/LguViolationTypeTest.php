...
class LguViolationTypeTest extends TestCase
{
    ...
    public function test_province_admin_sees_all_violation_types_across_lgus(): void
    {
        $lgu1 = Lgu::factory()->create(['name' => 'Balamban']);
        $lgu2 = Lgu::factory()->create(['name' => 'Asturias']);

        $vTypeGlobal = ViolationType::factory()->create(['name' => 'Global Speeding', 'lgu_id' => null]);
